...
var _user$fcc_bar_chart$Data$get = {
	ctor: '::',
	_0: {
		ctor: '_Tuple2',
		_0: 'AK',
...
var _user$fcc_bar_chart$Messages$Hover = function (a) {
	return {ctor: 'Hover', _0: a};
};

var _user$fcc_bar_chart$Model$getHovering = function (_p0) {
	var _p1 = _p0;
	return _p1._0.hovering;
};
var _user$fcc_bar_chart$Model$Model = function (a) {
	return {ctor: 'Model', _0: a};
};
var _user$fcc_bar_chart$Model$init = _user$fcc_bar_chart$Model$Model(
	{hovering: _elm_lang$core$Maybe$Nothing});
var _user$fcc_bar_chart$Model$setHovering = function (point) {
	return _user$fcc_bar_chart$Model$Model(
		{hovering: point});
};

var _user$fcc_bar_chart$Subscriptions$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};

var _user$fcc_bar_chart$Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return {
			ctor: '_Tuple2',
			_0: _user$fcc_bar_chart$Model$setHovering(_p0._0),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});

var _user$fcc_bar_chart$View$states = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'AK', _1: 'Alaska'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'AL', _1: 'Alabama'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'AR', _1: 'Arkansas'},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'AZ', _1: 'Arizona'},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'CA', _1: 'California'},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'CO', _1: 'Colorado'},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'CT', _1: 'Connecticut'},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'DE', _1: 'Delaware'},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'FL', _1: 'Florida'},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'GA', _1: 'Georgia'},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'HI', _1: 'Hawaii'},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'IA', _1: 'Iowa'},
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'ID', _1: 'Idaho'},
														_1: {
															ctor: '::',
															_0: {ctor: '_Tuple2', _0: 'IL', _1: 'Illinois'},
															_1: {
																ctor: '::',
																_0: {ctor: '_Tuple2', _0: 'IN', _1: 'Indiana'},
																_1: {
																	ctor: '::',
																	_0: {ctor: '_Tuple2', _0: 'KS', _1: 'Kansas'},
																	_1: {
																		ctor: '::',
																		_0: {ctor: '_Tuple2', _0: 'KY', _1: 'Kentucky'},
																		_1: {
																			ctor: '::',
																			_0: {ctor: '_Tuple2', _0: 'LA', _1: 'Louisiana'},
																			_1: {
																				ctor: '::',
																				_0: {ctor: '_Tuple2', _0: 'MA', _1: 'Massachusetts'},
																				_1: {
																					ctor: '::',
																					_0: {ctor: '_Tuple2', _0: 'MD', _1: 'Maryland'},
																					_1: {
																						ctor: '::',
																						_0: {ctor: '_Tuple2', _0: 'ME', _1: 'Maine'},
																						_1: {
																							ctor: '::',
																							_0: {ctor: '_Tuple2', _0: 'MI', _1: 'Michigan'},
																							_1: {
																								ctor: '::',
																								_0: {ctor: '_Tuple2', _0: 'MN', _1: 'Minnesota'},
																								_1: {
																									ctor: '::',
																									_0: {ctor: '_Tuple2', _0: 'MO', _1: 'Missouri'},
																									_1: {
																										ctor: '::',
																										_0: {ctor: '_Tuple2', _0: 'MS', _1: 'Mississippi'},
																										_1: {
																											ctor: '::',
																											_0: {ctor: '_Tuple2', _0: 'MT', _1: 'Montana'},
																											_1: {
																												ctor: '::',
																												_0: {ctor: '_Tuple2', _0: 'NC', _1: 'North Carolina'},
																												_1: {
																													ctor: '::',
																													_0: {ctor: '_Tuple2', _0: 'ND', _1: 'North Dakota'},
																													_1: {
																														ctor: '::',
																														_0: {ctor: '_Tuple2', _0: 'NE', _1: 'Nebraska'},
																														_1: {
																															ctor: '::',
																															_0: {ctor: '_Tuple2', _0: 'NH', _1: 'New Hampshire'},
																															_1: {
																																ctor: '::',
																																_0: {ctor: '_Tuple2', _0: 'NJ', _1: 'New Jersey'},
																																_1: {
																																	ctor: '::',
																																	_0: {ctor: '_Tuple2', _0: 'NM', _1: 'New Mexico'},
																																	_1: {
																																		ctor: '::',
																																		_0: {ctor: '_Tuple2', _0: 'NV', _1: 'Nevada'},
																																		_1: {
																																			ctor: '::',
																																			_0: {ctor: '_Tuple2', _0: 'NY', _1: 'New York'},
																																			_1: {
																																				ctor: '::',
																																				_0: {ctor: '_Tuple2', _0: 'OH', _1: 'Ohio'},
																																				_1: {
																																					ctor: '::',
																																					_0: {ctor: '_Tuple2', _0: 'OK', _1: 'Oklahoma'},
																																					_1: {
																																						ctor: '::',
																																						_0: {ctor: '_Tuple2', _0: 'OR', _1: 'Oregon'},
																																						_1: {
																																							ctor: '::',
																																							_0: {ctor: '_Tuple2', _0: 'PA', _1: 'Pennslyvania'},
																																							_1: {
																																								ctor: '::',
																																								_0: {ctor: '_Tuple2', _0: 'RI', _1: 'Rhode Island'},
																																								_1: {
																																									ctor: '::',
																																									_0: {ctor: '_Tuple2', _0: 'SC', _1: 'South Carolina'},
																																									_1: {
																																										ctor: '::',
																																										_0: {ctor: '_Tuple2', _0: 'SD', _1: 'South Dakota'},
																																										_1: {
																																											ctor: '::',
																																											_0: {ctor: '_Tuple2', _0: 'TN', _1: 'Tennessee'},
																																											_1: {
																																												ctor: '::',
																																												_0: {ctor: '_Tuple2', _0: 'TX', _1: 'Texas'},
																																												_1: {
																																													ctor: '::',
																																													_0: {ctor: '_Tuple2', _0: 'UT', _1: 'Utah'},
																																													_1: {
																																														ctor: '::',
																																														_0: {ctor: '_Tuple2', _0: 'VA', _1: 'Virginia'},
																																														_1: {
																																															ctor: '::',
																																															_0: {ctor: '_Tuple2', _0: 'VT', _1: 'Vermont'},
																																															_1: {
																																																ctor: '::',
																																																_0: {ctor: '_Tuple2', _0: 'WA', _1: 'Washington'},
																																																_1: {
																																																	ctor: '::',
																																																	_0: {ctor: '_Tuple2', _0: 'WI', _1: 'Wisconsin'},
																																																	_1: {
																																																		ctor: '::',
																																																		_0: {ctor: '_Tuple2', _0: 'WV', _1: 'West Virginia'},
																																																		_1: {
																																																			ctor: '::',
																																																			_0: {ctor: '_Tuple2', _0: 'WY', _1: 'Wyoming'},
																																																			_1: {ctor: '[]'}
																																																		}
																																																	}
																																																}
...
var _user$fcc_bar_chart$View$onHovering = F3(
	function (stuff, hovering, x) {
		return A2(
			_elm_lang$core$Maybe$andThen,
			function (p) {
...
var _user$fcc_bar_chart$View$normalHint = F2(
	function (label, y) {
		var recall = _elm_lang$core$Native_Utils.eq(y, 1) ? ' recall' : ' recalls';
		var stateName = A2(
			_elm_lang$core$Maybe$withDefault,
			label,
			A2(_elm_lang$core$Dict$get, label, _user$fcc_bar_chart$View$states));
		return A2(
			_elm_lang$html$Html$span,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id('hint'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$fcc_bar_chart$View$normalBarLabel = F2(
	function (label, position) {
		return {
			position: position,
			view: A2(
...
var _user$fcc_bar_chart$View$column = function (toGroups) {
	return {
		axis: _terezka$elm_plot$Plot$normalAxis,
		toGroups: toGroups,
		styles: {
			...
			_0: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$id('bar-chart'),
				_1: {ctor: '[]'}
			},
			_1: {ctor: '[]'}
		},
...
var _user$fcc_bar_chart$View$viewDataSource = A2(
	...
	{ctor: '[]'},
	{
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$href('https://open.fda.gov/food/enforcement/'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('FDA food recall enforcement reports'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		}
	});
var _user$fcc_bar_chart$View$viewTitle = A2(
	_elm_lang$html$Html$h1,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('Class I (Dangerous) Food Recalls in 2016'),
		_1: {ctor: '[]'}
	});
var _user$fcc_bar_chart$View$Bar = F2(
	function (a, b) {
		return {label: a, height: b};
	});
var _user$fcc_bar_chart$View$myHintGroup = F3(
	function (hovering, label, heights) {
		return {
			label: _user$fcc_bar_chart$View$normalBarLabel(label),
			verticalLine: A2(
				_user$fcc_bar_chart$View$onHovering,
				_terezka$elm_plot$Plot$fullLine(
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$id('hint-line'),
						_1: {ctor: '[]'}
					}),
				hovering),
			hint: function (g) {
				return A3(
					...
					A2(
						...
						A2(
							_elm_lang$core$List$map,
							_user$fcc_bar_chart$View$normalHint(label),
							heights)),
					hovering,
					g);
			},
			bars: A2(
				_elm_lang$core$List$map,
				_user$fcc_bar_chart$View$Bar(_elm_lang$core$Maybe$Nothing),
				heights)
		};
	});
var _user$fcc_bar_chart$View$viewBarChart = function (model) {
	var plotCustomizations = function () {
		var $default = _terezka$elm_plot$Plot$defaultBarsPlotCustomizations;
		return _elm_lang$core$Native_Utils.update(
			$default,
			{
				width: 1440,
				onHover: _elm_lang$core$Maybe$Just(_user$fcc_bar_chart$Messages$Hover),
				hintContainer: A2(
					_terezka$elm_plot$Plot$flyingHintContainer,
					_terezka$elm_plot$Plot$normalHintContainerInner,
					_user$fcc_bar_chart$Model$getHovering(model))
			});
	}();
	var oneHintBar = function (data) {
		return A3(
			_user$fcc_bar_chart$View$myHintGroup,
			_user$fcc_bar_chart$Model$getHovering(model),
			_elm_lang$core$Tuple$first(data),
			_elm_lang$core$Tuple$second(data));
	};
	var allHintBars = _user$fcc_bar_chart$View$column(
		_elm_lang$core$List$map(oneHintBar));
	return A3(_terezka$elm_plot$Plot$viewBarsCustom, plotCustomizations, allHintBars, _user$fcc_bar_chart$Data$get);
};
var _user$fcc_bar_chart$View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$fcc_bar_chart$View$viewTitle,
			_1: {
				ctor: '::',
				_0: _user$fcc_bar_chart$View$viewBarChart(model),
				_1: {
					ctor: '::',
					_0: _user$fcc_bar_chart$View$viewDataSource,
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$fcc_bar_chart$Main$init = {ctor: '_Tuple2', _0: _user$fcc_bar_chart$Model$init, _1: _elm_lang$core$Platform_Cmd$none};
var _user$fcc_bar_chart$Main$main = _elm_lang$html$Html$program(
	{init: _user$fcc_bar_chart$Main$init, update: _user$fcc_bar_chart$Update$update, subscriptions: _user$fcc_bar_chart$Subscriptions$subscriptions, view: _user$fcc_bar_chart$View$view})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$fcc_bar_chart$Main$main !== 'undefined') {
    _user$fcc_bar_chart$Main$main(Elm['Main'], 'Main', undefined);
}
